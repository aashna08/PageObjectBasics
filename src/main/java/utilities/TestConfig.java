...
public class TestConfig{
	...
	public static String from = "aashnagupta008@gmail.com";
	public static String password = "Engineer@828";
	public static String[] to ={"aashnagupta008@gmail.com","automation1234@mailinator.com"};
